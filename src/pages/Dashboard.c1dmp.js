...
const SIMPLE_COLUMNS = [
    { id: 'c1',  dataPath: 'created',          label: 'Created',            type: 'string', width: 130 },
    { id: 'c2',  dataPath: 'source',            label: 'Source',            type: 'string', width: 110 },
    { id: 'c3',  dataPath: 'campaign',          label: 'Campaign',          type: 'string', width: 150 },
    { id: 'c4',  dataPath: 'salesExec',         label: 'Sales Exec',        type: 'string', width: 120 },
    { id: 'c5',  dataPath: 'fullName',          label: 'Name',              type: 'string', width: 150 },
    { id: 'c6',  dataPath: 'email',             label: 'Email',             type: 'string', width: 180 },
    { id: 'c7',  dataPath: 'phone',             label: 'Phone',             type: 'string', width: 130 },
    { id: 'c8',  dataPath: 'preferredChannel',  label: 'Pref. Channel',     type: 'string', width: 110 },
    { id: 'c9',  dataPath: 'preferredTime',     label: 'Pref. Time',        type: 'string', width: 100 },
    { id: 'c10', dataPath: 'model',             label: 'Model',             type: 'string', width: 120 },
];
