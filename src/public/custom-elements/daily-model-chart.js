/* global Chart */
// ─────────────────────────────────────────────────────────────────────────────
//  CRAMS-AMS · daily-model-chart.js
//  Place in: src/public/custom-elements/daily-model-chart.js
//  Custom element tag: <daily-model-chart>
//  Row 1, Col 2: Daily Leads by Model (stacked bar per day)
// ─────────────────────────────────────────────────────────────────────────────

class DailyModelChart extends HTMLElement {
    constructor() {
        super();
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        if (name === 'data-chart' && newValue) {
            ...
            catch (e) { console.error('daily-model-chart: invalid data', e); }
        }
    }
    ...
    renderChart(chartData) {
        ...
        this.chartInstance = new Chart(this.canvas.getContext('2d'), {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true, text: 'Daily Leads by Model',
...
customElements.define('daily-model-chart', DailyModelChart);