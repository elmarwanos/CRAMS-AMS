...
// @ts-nocheck
// ─────────────────────────────────────────────────────────────────────────────
//  CRAMS-AMS · pref-channel-chart.js
//  Custom element tag: <pref-channel-chart>
//  Wix element ID:     #prefChannelChart
//  Doughnut — Preferred Contact Channel breakdown
// ─────────────────────────────────────────────────────────────────────────────

class PrefChannelChart extends HTMLElement {
    constructor() {
        super();
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        if (name === 'data-chart' && newValue) {
            ...
            catch (e) { console.error('pref-channel-chart: invalid data', e); }
        }
    }
...
customElements.define('pref-channel-chart', PrefChannelChart);
